...
import { history_SliceActions } from "../store/historySlice"
...
export const Translayout =({title,data})=>{
    ...
    const handleSelectChange=()=>{
        dispatch(history_SliceActions.sortDataByAmount())
    }

    const handleInputChange=(e)=>{
        dispatch(history_SliceActions.searchdata(e.target.value))
    }
    return(
        <div className="px-4">
           { title && (
